...
#> 1. gliogenesis (p.adj = 1.57e-13)
#> 2. regulation of gliogenesis (p.adj = 1.31e-12)
#> 3. regulation of glial cell proliferation (p.adj = 1.52e-12)
#> 4. regulation of nervous system development (p.adj = 1.57e-12)
#> 5. glial cell differentiation (p.adj = 1.57e-12)
...
#>                             Estimate Std. Error     t value
#> (Intercept)             19.779745531 0.05508533 359.0746584
...
#> Mixed model for MYC :
#>                            Estimate Std. Error     t value
#> (Intercept)             19.61741226 0.06252496 313.7533033
