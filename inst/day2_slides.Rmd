...
for (i in 1:nrow(protein_matrix)) {
  # take one row
  row_values <- protein_matrix[i, ]
  # count how many NAs are in the row
  na_number <- sum(is.na(row_values))
  # save the result
  na_counts[i] <- na_number
}

# see the NA of all rows
na_counts
```
]
